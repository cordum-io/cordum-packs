...
func (c *Client) Do(ctx context.Context, method, path string, query url.Values, body any, extraHeaders map[string]string) (any, int, error) {
	...
	if resp.StatusCode < 200 || resp.StatusCode >= 300 {
		...
		return payloadResp, resp.StatusCode, fmt.Errorf("pagerduty error: %s", msg)
	}
