...
from .executor import CrewAIExecutor
...
def create_app(executor: Executor | None = None):
    ...
    app = Flask(__name__)
    app.config["EXECUTOR"] = executor or CrewAIExecutor()
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cordum CrewAI Python sidecar server")
